...
# TestP2PConn: A peer we use to send messages to trustcoind, and store responses.
...
class CompactBlocksTest(TrustcoinTestFramework):
    ...
    # This test actually causes trustcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that trustcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for trustcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # trustcoind will not send blocktxn responses for blocks whose height is
