...
"""Verify that starting trustcoin with -h works as expected."""

from test_framework.test_framework import TrustcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(TrustcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start trustcoin with -h for help text")
        ...
        self.log.info("Start trustcoin with -version for version information")
        ...
        self.log.info("Start trustcoind with -fakearg to make sure it does not start")
