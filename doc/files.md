...
* trustcoin.conf: contains configuration settings for trustcoind or trustcoin-qt
* trustcoind.pid: stores the process id of trustcoind while running
...
* debug.log: contains debug information and general logging generated by trustcoind or trustcoin-qt
