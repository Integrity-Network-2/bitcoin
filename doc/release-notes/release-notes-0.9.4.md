Trustcoin Core version 0.9.4 is now available from:

  https://trustcoin.org/bin/0.9.4/
...
this update is incompatible with the Trustcoin system and could lead to consensus
forks.

Trustcoin Core released binaries from https://trustcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~trustcoin/+archive/ubuntu/trustcoin
- A third-party or self-compiled Trustcoin Core

upgrade to Trustcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
