Trustcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/trustcoin/files/Trustcoin/trustcoin-0.5.4/
...
http://gitorious.org/trustcoin/trustcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Trustcoin-Qt notifications under Growl 1.3.
Increase required age of Trustcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTrustcoin properly when installing Trustcoin-Qt over it. (Windows)
