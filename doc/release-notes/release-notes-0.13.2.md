Trustcoin Core version 0.13.2 is now available from:

  <https://trustcoin.org/bin/trustcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update trustcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow trustcoin-tx to create v2 transactions (btcdrak)
