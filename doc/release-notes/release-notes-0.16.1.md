Trustcoin Core version 0.16.1 is now available from:

  <https://trustcoincore.org/bin/trustcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting trustcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure trustcoind processes are cleaned up when tests end (sdaftuar)
