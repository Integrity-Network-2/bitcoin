Trustcoin Core version 0.9.1 is now available from:

  https://trustcoin.org/bin/0.9.1/
...
trustcoind from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Trustcoin Core software:
