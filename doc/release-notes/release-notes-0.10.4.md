Trustcoin Core version 0.10.4 is now available from:

  <https://trustcoin.org/bin/trustcoin-core-0.10.4/>
...
- #6953 `43c2789` Split trustcoin-tx into its own package
- #6953 `dfe0d4d` Include trustcoin-tx binary on Debian/Ubuntu
