Trustcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/trustcoin/files/Trustcoin/trustcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Trustcoin
...
New/changed settings (command-line or trustcoin.conf file)
--------------------------------------------------------
