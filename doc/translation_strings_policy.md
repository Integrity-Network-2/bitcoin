...
This document provides guidelines for internationalization of the Trustcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `trustcoin_en.ts` remains unchanged.
