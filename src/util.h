 ...
 */
#ifndef TRUSTCOIN_UTIL_H
#define TRUSTCOIN_UTIL_H
...
extern const char * const TRUSTCOIN_CONF_FILENAME;
extern const char * const TRUSTCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("trustcoin-%s", name);
