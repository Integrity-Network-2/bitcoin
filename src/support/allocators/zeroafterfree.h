...
#ifndef TRUSTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define TRUSTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // TRUSTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
