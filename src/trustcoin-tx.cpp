...
static void SetupTrustcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " trustcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  trustcoin-tx [options] <hex-tx> [commands]  Update hex-encoded trustcoin transaction\n" +
            "or:     trustcoin-tx [options] -create [commands]   Create hex-encoded trustcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded trustcoin transaction
