...
#ifndef TRUSTCOIN_WALLET_WALLET_H
#define TRUSTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this trustcoin node, and set to 0 for transactions that were created
...
#endif // TRUSTCOIN_WALLET_WALLET_H
