...
#ifndef TRUSTCOIN_INTERFACES_NODE_H
#define TRUSTCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a trustcoin node (trustcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // TRUSTCOIN_INTERFACES_NODE_H
