...
#ifndef TRUSTCOIN_TEST_SCRIPTNUM10_H
#define TRUSTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Trustcoin Core 0.10.0, for cross-comparison.
 */
public:
