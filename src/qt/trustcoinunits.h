...
#ifndef TRUSTCOIN_QT_TRUSTCOINUNITS_H
#define TRUSTCOIN_QT_TRUSTCOINUNITS_H
...
/** Trustcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TrustcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TrustcoinUnits(QObject *parent);

    /** Trustcoin units.
      @note Source: https://en.trustcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef TrustcoinUnits::Unit TrustcoinUnit;

#endif // TRUSTCOIN_QT_TRUSTCOINUNITS_H
