    ...
    mapper(0)
{
    ...
    ui->trustcoinAtStartup->setToolTip(ui->trustcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->trustcoinAtStartup->setText(ui->trustcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openTrustcoinConfButton->setToolTip(ui->openTrustcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new TrustcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->trustcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTrustcoinConfButton_clicked()
{
